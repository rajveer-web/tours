...
<td><a class="fancybox" style=" margin-left:5px;"  href="admin/pic/<?php echo $fetch['photo']; ?>" data-fancybox-group="gallery"><img width="230" height="150" style="margin-top:30px;" align="baseline" src="admin/pic/<?php echo $fetch['photo']; ?>"/></a></td>
</tr>
