...
if(isset($_POST['submit']))
{
	...
	$query2="insert into bb(name,pack,photo,desp)values('$name','$pack','$photo','$desp')";
...
<fieldset>
<legend> Upload Data of Himachal</legend>
...
<td><a href="dhim.php<?php echo '?id='.$info['id']; ?>">delete</a></td>

<td><a href="ehim.php<?php echo '?id='.$info['id']; ?>">Edit</a></td>
</tr>
<?php
}
?>
