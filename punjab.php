...
<div id="splash">
<input type="image" src="images/the-golden-temple-60a.jpg" align="left" height="266px" width="754"/> 
</div>
<nav id="ddmenu">
...
?>
      <a href="pun.php?id=<?php echo $rows['id'] ; ?>">
  ...
  <tr>
    <td ><a href="punjab (2).php?id=<?php echo $rows['id'] ; ?>"><img src="admin/jammu/<?php echo $rows['photo'] ; ?>" width="155" height="118" class="imgpic"></td></a>
  </tr>
</table>
</div>
      <?php
