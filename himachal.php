...
<div id="splash">
<input type="image" src="images/12.png" align="left" height="266px" width="754"/> 
</div>
<nav id="ddmenu">
...
<?php
	  $query=mysql_query("select * from bb");
	  while($rows=mysql_fetch_array($query)){
?>
      <a href="him.php?id=<?php echo $rows['id'] ; ?>">
  ...
  <tr>
    <td ><a href="himachal (2).php?id=<?php echo $rows['id'] ; ?>"><img src="admin/jammu/<?php echo $rows['photo'] ; ?>" width="155" height="118" class="imgpic"></td></a>
  </tr>
</table>
</div>
      <?php
