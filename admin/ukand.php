...
if(isset($_POST['submit']))
{
	...
	$query2="insert into ukand(name,pack,photo,desp)values('$name','$pack','$photo','$desp')";
...
<fieldset>
<legend> Upload Data of Uttarkand</legend>
...
<td><a href="duk.php<?php echo '?id='.$info['id']; ?>">delete</a></td>

<td><a href="euk.php<?php echo '?id='.$info['id']; ?>">Edit</a></td>
</tr>
<?php
}
?>
