...
if(isset($_POST['submit']))
{
	...
	$query2="insert into up(name,pack,photo,desp)values('$name','$pack','$photo','$desp')";
...
<fieldset>
<legend> Upload Data of U.P</legend>
...
<td><a href="dup.php<?php echo '?id='.$info['id']; ?>">delete</a></td>

<td><a href="eup.php<?php echo '?id='.$info['id']; ?>">Edit</a></td>
</tr>
<?php
}
?>
