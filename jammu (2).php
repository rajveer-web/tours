...
<marquee>
<table>
<img src="images/DAL/bahufort.jpg" width="250" height="150" />
<img src="images/DAL/Dal_LakeVR.jpg" width="250" height="150" />
<img src="images/DAL/images.jpg" width="250" height="150" />
<img src="images/DAL/Chashme-Shahi-Srinagar.jpg" width="250" height="150" />
<img src="images/DAL/jama masjid.jpg" width="250" height="150" />
<img src="images/DAL/Ladakh_Monastery.jpg" width="250" height="150" />
</table>
</marquee>
<div id="sidebar">
<ul>
...
@$desp=$_POST['desp'];
@$photo=$_POST['photo'];
$select="select * from jammu where id ='$id'";
