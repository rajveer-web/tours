...
if(isset($_POST['submit']))
{
	...
	$query2="insert into jammu(name,pack,photo,desp)values('$name','$pack','$photo','$desp')";
...
<fieldset>
<legend> Upload Data of Jammu and Kashmir</legend>
...
<td><a href="delete.php<?php echo '?id='.$info['id']; ?>">delete</a></td>

<td><a href="edit.php<?php echo '?id='.$info['id']; ?>">Edit</a></td>
</tr>
<?php
}
?>
